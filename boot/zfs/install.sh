...
cp "$HERE/src/sha512.c"     "$LIBSA/zfs_sha512.c"
cp "$HERE/src/sha512.h"     "$LIBSA/sha512.h"
cp "$HERE/src/skein.c"      "$LIBSA/zfs_skein.c"
cp "$HERE/src/skein.h"      "$LIBSA/skein.h"
cp "$HERE/src/edonr.c"      "$LIBSA/zfs_edonr.c"
cp "$HERE/src/edonr.h"      "$LIBSA/edonr.h"
cp "$HERE/src/blake3.c"     "$LIBSA/zfs_blake3.c"
cp "$HERE/src/blake3.h"     "$LIBSA/blake3.h"
...
/^\.include <bsd\.lib\.mk>/ && !done {
	...
	print "\tzfs_sha512.c zfs_skein.c zfs_edonr.c zfs_blake3.c"
	print "#"
