...
#
# Not covered here, for want of a pool that has them: gang blocks,
# more than one disk, zstd.  test/openzfs.sh and test/zstd.sh cover
# those, where OpenZFS and the zstd command can make them.
#
